...
import { Mail, Lock, Briefcase, MapPin, AlertCircle } from 'lucide-react';
...
export const Signup: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signUp(email, password, businessName, city);
      navigate('/dashboard');
    } catch (err: any) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="mb-8">
            ...
            <p className="text-slate-600">Join BidFix and start bidding</p>
          </div>
